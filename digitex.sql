...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 15 août 2022 à 10:19
...
CREATE TABLE `interventions` (
  ...
  `intervention_time` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `spare_time` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `cur_date` date DEFAULT curdate(),
  `cur_time` time DEFAULT curtime()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `packets`
  ...
  ADD KEY `fab_order_id` (`fab_order_id`);
...
--
ALTER TABLE `packets`
  ADD CONSTRAINT `packets_ibfk_1` FOREIGN KEY (`fab_order_id`) REFERENCES `fab_orders` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `pack_gamuts`
--
ALTER TABLE `pack_gamuts`
  ADD CONSTRAINT `pack_gamuts_ibfk_1` FOREIGN KEY (`fab_order_id`) REFERENCES `fab_orders` (`id`) ON DELETE CASCADE,
