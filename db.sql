...
CREATE TABLE prod_lines(
    ...
    operator_reg_num VARCHAR(20) NOT NULL DEFAULT '',
    monitor_reg_num VARCHAR(20) NOT NULL DEFAULT '',
...
CREATE TABLE fab_orders(
    ...
    prod_line VARCHAR(40) NOT NULL DEFAULT '',
...
CREATE TABLE gamuts(
    id INT NOT NULL AUTO_INCREMENT,
    fab_order_number VARCHAR(80) NOT NULL,
    operation_code VARCHAR(40) NOT NULL DEFAULT '',
    designation VARCHAR(80) NOT NULL DEFAULT '',
    unit_time VARCHAR(40) NOT NULL DEFAULT '',
    qte_h VARCHAR(40) NOT NULL DEFAULT '',
    import_date DATE DEFAULT CURDATE(),
    import_time TIME DEFAULT CURTIME(),
    PRIMARY KEY(id),
    FOREIGN KEY (fab_order_number) REFERENCES fab_orders(number) ON DELETE CASCADE
...
CREATE TABLE pack_gamuts(
    id INT NOT NULL AUTO_INCREMENT,
    fab_order_number VARCHAR(80) NOT NULL,
    pack_num VARCHAR(40) NOT NULL DEFAULT '',
    operation_code VARCHAR(40) NOT NULL DEFAULT '',
    designation VARCHAR(80) NOT NULL DEFAULT '',
    unit_time VARCHAR(40) NOT NULL DEFAULT '',
    qte_h VARCHAR(40) NOT NULL DEFAULT '',
